						...
						<fieldset>
							...
							<ul class="reg_list">
								<li class="clear">
									...
									<div class="reg_content" style="padding-top:8px;"><input type="text" class="w70p" placeholder="이름" value="${sessionScope.userDTO.name }" name="name" required/></div>
								</li>
									<li class="clear">
									<span class="tit_lbl">성별</span>
									<div class="reg_content radio_area">
										<input type="radio" class="css-radio" id="mmm_lbl" name="gender" value="M" ${sessionScope.userDTO.gender == 'M' ? 'checked' : '' } ><label for="mmm_lbl">남</label>
										<input type="radio" class="css-radio" id="www_lbl" name="gender" value="F" ${sessionScope.userDTO.gender == 'F' ? 'checked' : '' } ><label for="www_lbl">여</label>
									</div>
								</li>
								<!-- 
								<li class="clear">
								...
								<li class="clear">
									...
									<div class="reg_content" style="padding-top:8px;"><input type="text" class="w70p" placeholder="010-0000-0000" value="${sessionScope.userDTO.phone }" name="phone" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}"/></div>
								</li>
								<li class="clear">
									<span class="tit_lbl">SMS 수신동의</span>
									<div class="reg_content radio_area">
										<input type="radio" class="css-radio" id="smsyes_lbl" name="sns_yn" value="Y" ${sessionScope.userDTO.snsYn == 'Y' ? 'checked' : '' }><label for="smsyes_lbl">허용</label>
										<input type="radio" class="css-radio" id="smsno_lbl" name="sns_yn"  value="N" ${sessionScope.userDTO.snsYn == 'N' ? 'checked' : '' }><label for="smsno_lbl">거부</label>
